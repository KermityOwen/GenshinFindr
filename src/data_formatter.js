...
async function create_character_embed(data, index=1, callback){
    try{
        ...
        return callback(null, characterEmbed)
    } catch (e){
        return callback(e)
    }
}
...
async function create_select_character (data, uid, callback) {
    const option = []
    try{
